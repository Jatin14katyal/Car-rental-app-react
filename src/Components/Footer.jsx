    ...
    <footer className='bg-gray-900 text-gray-300 py-16 px-4 sm:px-6 lg:px-20'>
        <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10'>
            <div>
                ...
                <Car className='w-8 h-8 text-blue-500'/> <span className='text-xl font-bold'>AutoRent</span></Link>
                <p className='leading-relaxed my-4'>Your trusted partner for premium car rentals. Experience the freedon of the road with our quality vehicles and exceptional service.</p>
            ...
            <div >
                ...
                <ul className='space-y-2'>
                    ...
                    <li><a href="#" className='hover:underline'>Cotact</a></li>
            ...
            <div>
                ...
                <ul className='space-y-2'>
                    ...
                    <li><a href="" className='hover:underline'>SUV & Trucks</a></li>
            ...
            <div>
                ...
                <ul className='space-y-3'>
                    <li className='flex items-center gap-2'><Phone className='text-blue-400 w-5 h-5'/>+91 997-117-0991</li>
                    <li className='flex items-center gap-2'><Mail className='text-blue-400 w-5 h-5'/> katyajsaab496@gmail.com</li>
                    <li className='flex items-center gap-2'><MapPin className='text-blue-400 w-5 h-5'/>Krishna Nagar, Delhi 110051</li>
                </ul>
            </div>
        </div>
